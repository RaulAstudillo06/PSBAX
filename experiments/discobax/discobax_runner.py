...
# === To RUN === # 
# python discobax_runner.py -s --max_iter 10 --do_pca --pca_dim 5 --data_size 5000 --eta_budget 100 --batch_size 1 --policy ps 
...
obj_func.initialize(seed=0, verbose=True) # if etas is None, generates etas
...
algo.set_obj_func(obj_func) # Need to set obj_func for algo (and reset every time obj_func is updated because of etas)
